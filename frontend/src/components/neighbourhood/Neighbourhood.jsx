...
export default function Neighborhood() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute left-1/2 top-[4vh] z-30 -translate-x-1/2 rounded-full bg-amber-950/80 px-[2vh] py-[1vh] text-[1.5vh] font-medium text-amber-50 shadow-lg backdrop-blur whitespace-nowrap">
        Drag the street &nbsp;·&nbsp; tap your glowing home to enter
      </div>
